export function Ajuda() {
  const faqItems = [
    ...
    },
    {
      ...
      a: "Sim, a plataforma é exclusiva para pessoas jurídicas. Embarcadores e transportadoras precisam de CNPJ ativo. Transportadoras também precisam de RNTRC (AN TT) regular.",
    },
    {
      q: "Quanto custa?",
    ...
    },
    {
      ...
      a: "Se você já usa o Tradexa para classificação NCM de seus produtos, os dados são automaticamente aproveitados para cotar fretes. Isso elimina retrabalho e garante compliance regulatório completo (AN TT, ANVISA, Exército, IBAMA).",
    },
    {
